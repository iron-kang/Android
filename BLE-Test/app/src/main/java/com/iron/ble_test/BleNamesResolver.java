...
public class BleNamesResolver {
	...
	static {
		...
		mServices.put("000000ff-0000-1000-8000-00805f9b34fb", "Iron Service A");
		mServices.put("000000ee-0000-1000-8000-00805f9b34fb", "Iron Service B");
		...
		mCharacteristics.put("0000ff01-0000-1000-8000-00805f9b34fb", "Iron Char A");
		mCharacteristics.put("0000ee01-0000-1000-8000-00805f9b34fb", "Iron Char B");
